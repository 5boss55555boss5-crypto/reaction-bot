...
Вибери ОДНУ реакцію з цього списку: ❤ 👍 🔥 👏 🏆 🎉 🥰 💯 ⚡ 🤩 💪 🤣 😱 🤯 😢 🤔 😈 👀 🙏 😭 🤬

ВАЖЛИВО: у 70% випадків відповідай ❤. Інші емодзі — лише для дуже яскравих випадків:
- Звичайна новина, анонс, статистика → ❤
- Гол, перемога → ❤ або 🔥 (НЕ 🏆)
- 🏆 тільки якщо пост про здобуття трофею/чемпіонства
- Сумна новина → 😢
- Смішне → 🤣
- Шок → 😱
